...
export class AIService {
  ...
  async generateResponse(
    ...
    console.log(`🤖 Generating ${assistantType} response for ${userRole} user...`);
    ...
    if (this.openaiClient) {
      try {
        ...
        console.warn('🧠 OpenAI API failed, using enhanced mock responses...', error);
      }
    }
    
    console.log('🎭 Using enhanced mock AI responses...');
